...
CREATE TABLE `tb_cars` (
  ...
  `car_model` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `car_brand` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `car_year` char(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`car_id`)
...
-- Dump completed on 2020-11-06 13:43:22
